...
export default function AccountAccess() {
  ...
  function submitSignup(event: FormEvent<HTMLFormElement>) {
    ...
    run(async () => {
      ...
      if (result.signedIn) return window.location.assign("/");
  ...
  return <main className="auth-page access-page"><div className="auth-card">
    ...
    {demo && <a className="access-demo-link" href="/">Open sample account</a>}
    <div className="access-footer"><ShieldCheck size={15} /> Restaurant partner? <a href="/partner/login">Partner sign in</a></div>
  </div></main>;
}
